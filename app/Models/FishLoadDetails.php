 ...
 */
class FishLoadDetails extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'fish_loads_details';
     ...
     */
    protected $casts = [
        'quantity' => 'double', 'fish_type_id' => 'int', 'fish_load_id' => 'int', 
    ];
    ...
    public function fishLoad()
    {
        return $this->belongsTo(FishLoad::class);
    }
}
